...
bool dvmHeapStartup()
{
    ...
    //printf("ZHK in Heap.cpp:86 \n");
	if (gcHeap == NULL) {
		printf("ZHK in Heap.cpp:87 gcHeap==NULL\n");
        return false;
    }
	//printf("ZHK in Heap.cpp:91 \n");
