...
static bool initClassReference(ClassObject** pClass, const char* name) {
	//printf("ZHK initClassReference:25 == %s\n", name);
    ClassObject* result;
	...
	//printf("ZHK initClassReference:35\n");
    if (result == NULL) {
		printf("Could not find essential class %s", name);
...
static bool initClassReferences() {
	printf("ZHK initClassReferences:45\n");
	//ZHKTODO
	...
	printf("ZHK initClassReferences:145\n");
    int i;
...
static bool initFieldOffsets() {
	printf("ZHK initFieldOffsets:169\n");
    struct FieldInfo {
        int* offset;
        const char* name;
        const char* type;
...
static bool initConstructorReferences() {
	printf("ZHK initConstructorReferences:326\n");
...
static bool initDirectMethodReferences() {
	printf("ZHK initDirectMethodReferences:357\n");
    static struct {
        Method** method;
...
static bool initVirtualMethodOffsets() {
	printf("ZHK initVirtualMethodOffsets:420\n");
    static struct {
        int* offset;
        const char* className;
        const char* name;
...
{
	printf("ZHK initFinalizerReference:453\n");
...
static bool verifyStringOffsets() {
     ...
     * the class.
     */
	printf("ZHK verifyStringOffsets:475\n");
    bool ok = true;
...
bool dvmFindRequiredClassesAndMembers() {
     ...
     */
	printf("ZHK dvmFindRequiredClassesAndMembers:487\n");
