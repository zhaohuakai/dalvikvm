...
{
	//printf("ZHK in LinearAlloc.cpp:110\n");
#ifdef DISABLE_LINEAR_ALLOC
    return (LinearAllocHdr*) 0x12345;
#endif
	//printf("ZHK in LinearAlloc.cpp:114\n");
    LinearAllocHdr* pHdr;

    pHdr = (LinearAllocHdr*) malloc(sizeof(*pHdr));

	//printf("ZHK in LinearAlloc.cpp:119\n");
    /*
	...
	//printf("ZHK in LinearAlloc.cpp:153\n");
    close(fd);
#else /*USE_ASHMEM*/
